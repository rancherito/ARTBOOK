	...
	<div id="app-body">
		...
		<div class="fixed-action-btn">
			<a class="btn-floating btn-large">
				<svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="30" version="1.1" style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd" viewBox="0 0 1497.42 1664.17">
					<g>
			...
			<ul id="nav-movil">
				...
				<?php if (isset($_SESSION['access']) && base_url().$_SERVER['REQUEST_URI'] != $_SESSION['access']['account_site']):?>
					<li>
						<a href="<?= $_SESSION['access']['account_site'] ?>" class="btn-floating"> <i class="mdi mdi-account mdi-24px"></i></a>
					</li>
				<?php endif; ?>
				<?php foreach ($links as $key => $link): ?>
					<li>
						<a href="<?= $link['url'] ?>" class="btn-floating">
							<i class="mdi-24px <?= $link['classicon'] ?>"></i>
						</a>
					</li>
				<?php endforeach; ?>
